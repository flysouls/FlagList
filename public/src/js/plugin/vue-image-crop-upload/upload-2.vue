    ...
    <div class="vicp-wrap">
        ...
        <div class="vicp-step1" v-show="step == 1">
            <div class="vicp-drop-area" @dragleave="preventDefault" @dragover="preventDefault" @dragenter="preventDefault" @click="handleClick" @drop="handleChange">
                ...
                <input type="file" :accept="inputAccept" v-show="false" v-if="step == 1" @change="handleChange" ref="fileinput">
            </div>
            ...
            <div class="vicp-crop">
                ...
                <div class="vicp-crop-right" v-show="true">
                    <div class="vicp-preview">
                        ...
                        <div class="vicp-preview-item"  :style="{visibility:noCircle?'hidden':'visible'}">
                            <img :src="createImgUrl" :style="previewStyle">
                            <span>{{ lang.preview }}</span>
                        </div>
                    </div>
                ...
                function(resData) {
                    if (that.value) {
                        ...
                        if(resData.code==200){
                            ...
                            that.loading = 3;
                            that.hasError = true;
                            that.errorMsg = resData.msg;
                            that.$emit('crop-upload-fail', 400, field, ki);
                        }
                    }
