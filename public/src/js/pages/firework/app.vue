...
export default {
  ...
  methods:{
    full(){
      ...
      if (this.isfull) {
        const exitfull = () => document.cancelFullScreen || document.webkitCancelFullScreen || 
          document.mozCancelFullScreen || document.exitFullScreen;
        this.isfull = false;
        exitfull.call(window.document);
      } else {
        const fullscreen = canvas.requestFullScreen || canvas.webkitRequestFullScreen || 
